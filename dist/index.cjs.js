...
var Logo = function (_a) {
    ...
    //   <path fill="none" stroke="black" d="M 36.35,10.92
    //        C 36.35,10.92 36.35,29.08 36.35,29.08
    //          36.35,29.08 3.65,29.08 3.65,29.08
    //          3.65,29.08 3.65,10.92 3.65,10.92
    //          3.65,10.92 36.35,10.92 36.35,10.92 Z
    //        M 3.65,0.02
    //        C 3.65,0.02 3.65,39.98 3.65,39.98M 7.29,0.02
    //        C 7.29,0.02 7.29,39.98 7.29,39.98M 10.92,0.02
    //        C 10.92,0.02 10.92,39.98 10.92,39.98M 14.55,0.02
    //        C 14.55,0.02 14.55,39.98 14.55,39.98M 18.18,0.02
    //        C 18.18,0.02 18.18,39.98 18.18,39.98M 21.82,0.02
    //        C 21.82,0.02 21.82,39.98 21.82,39.98M 25.45,0.02
    //        C 25.45,0.02 25.45,39.98 25.45,39.98M 29.08,0.02
    //        C 29.08,0.02 29.08,39.98 29.08,39.98M 32.71,0.02
    //        C 32.71,0.02 32.71,39.98 32.71,39.98M 36.35,0.02
    //        C 36.35,0.02 36.35,39.98 36.35,39.98M 0.02,3.65
    //        C 0.02,3.65 39.98,3.65 39.98,3.65M 0.02,7.29
    //        C 0.02,7.29 39.98,7.29 39.98,7.29M 0.02,10.92
    //        C 0.02,10.92 39.98,10.92 39.98,10.92M 0.02,14.55
    //        C 0.02,14.55 39.98,14.55 39.98,14.55M 0.02,18.18
    //        C 0.02,18.18 39.98,18.18 39.98,18.18M 0.02,21.82
    //        C 0.02,21.82 39.98,21.82 39.98,21.82M 0.02,25.45
    //        C 0.02,25.45 39.98,25.45 39.98,25.45M 0.02,29.08
    //        C 0.02,29.08 39.98,29.08 39.98,29.08M 0.02,32.71
    //        C 0.02,32.71 39.98,32.71 39.98,32.71M 0.02,36.35
    //        C 0.02,36.35 39.98,36.35 39.98,36.35M 39.98,0.02
    //        C 39.98,0.02 39.98,39.98 39.98,39.98
    //          39.98,39.98 0.02,39.98 0.02,39.98
    //          0.02,39.98 0.02,0.02 0.02,0.02
    //          0.02,0.02 39.98,0.02 39.98,0.02 Z" />
    // </Svg>
    React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 160 26" }, props),
    ...
    return (React__default['default'].createElement(Wrapper$1, null,
        React__default['default'].createElement(StyledNav, { showMenu: showMenu },
            ...
            React__default['default'].createElement(Flex, null,
                React__default['default'].createElement("ul", { style: { listStyleType: "none" } },
                    React__default['default'].createElement("li", null,
                        React__default['default'].createElement("a", { style: { textDecoration: "none", display: "inline-block" }, href: "/swap" }, "Swap")),
                    React__default['default'].createElement("li", null,
                        React__default['default'].createElement("a", { style: { textDecoration: "none", display: "inline-block" }, href: "/farm" }, "Farms")),
                    React__default['default'].createElement("li", null,
                        React__default['default'].createElement("a", { style: { textDecoration: "none", display: "inline-block" }, href: "/pools" }, "Pools")),
                    React__default['default'].createElement("li", null,
                        React__default['default'].createElement("a", { style: { textDecoration: "none", display: "inline-block" }, href: "/bush" }, "Quasar"))),
...
var templateObject_1$H, templateObject_2$e, templateObject_3$7, templateObject_4$3, templateObject_5$1;
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#ffffff", backgroundDisabled: "#E9EAEB", contrast: "#191326", invertedContrast: "#FFFFFF", input: "#eeeaf4", inputSecondary: "#d7caec", tertiary: "#EFF4F5", 
    ...
    // textSubtle: "#62815c",
    textSubtle: "#000000", borderColor: "#E9EAEB", card: "#FFFFFF", nav: "#f9fdf9", gradients: {
